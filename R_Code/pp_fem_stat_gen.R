...
pp.fem.stat.gen <- list(p.hi.ngend = p.hi.ngend, p.lo.ngend = p.lo.ngend, fd.ngend = fd.ngend, rr.ngend = rr.ngend, or.ngend = or.ngend,
                p.hi.gend = p.hi.gend, p.lo.gend = p.lo.gend, fd.gend = fd.gend, rr.gend = rr.gend, or.gend = or.gend)

save(pp.fem.stat.gen, file = "R_Images/pp_fem_stat_gen.RData")